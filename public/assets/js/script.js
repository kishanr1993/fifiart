...
const loginmodalPopup = function () {
    let loginmodalWrapper = document.querySelector(".loginmodal__popup"),
            loginmodalCloseButton = document.querySelector(".loginmodal__popup--close__btn");
    loginmodalWrapper &&
            document.body.classList.add("overlay__active"),
            loginmodalWrapper.classList.add("loginmodal__show"),
            loginmodalCloseButton.addEventListener("click", function () {
                document.body.classList.remove("overlay__active"), loginmodalWrapper.classList.remove("loginmodal__show");
            });
};