...
@endif
    ...
    @endif
            ...
            <link rel="stylesheet" href="{{ static_asset('assets/css/plugins/glightbox.min.css') }}">
            ...
            <!-- Plugin css -->
            <!-- <link rel="stylesheet" href="{{ static_asset('assets/css/vendor/bootstrap.min.css') }}"> -->
...
@endphp
  ...
  <!-- <script src="{{ static_asset('assets/js/vendor/popper.js') }}" defer="defer"></script> -->
  <!-- <script src="{{ static_asset('assets/js/vendor/bootstrap.min.js') }}" defer="defer"></script> -->

        <script src="{{ static_asset('assets/js/plugins/swiper-bundle.min.js') }}" defer="defer"></script>
        <script src="{{ static_asset('assets/js/plugins/glightbox.min.js') }}" defer="defer"></script>
        ...
        <script>
            $(document).ready(function() {
                ...
                if ($('#lang-change').length > 0) {
                    $('#lang-change .dropdown-menus a').each(function() {
                ...
                if ($('#currency-change').length > 0) {
                    $('#currency-change .dropdown-menus a').each(function() {
                        $(this).on('click', function(e){
                            e.preventDefault();
                            var $this = $(this);
