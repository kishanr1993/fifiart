                ...
                <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="home-slider-target">
                            ...
                            <input type="hidden" name="types[]" value="home_slider_contents">
                            ...
                            <div class="row gutters-5">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <input type="hidden" name="types[]" value="home_slider_titles">
                                        <input type="text" class="form-control" placeholder="{{translate('Title')}}" name="home_slider_titles[]" value="{{ json_decode(get_setting('home_slider_titles'), true)[$key] }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <input type="hidden" name="types[]" value="home_slider_contents">
                                        <input type="text" class="form-control" placeholder="{{translate('Add Content')}}" name="home_slider_contents[]" value="{{ json_decode(get_setting('home_slider_contents'), true)[$key] }}">
                                    </div>
                                </div>
                        ...
                        <button
                            ...
                            <div class="form-group">
                            <input type="hidden" name="types[]" value="home_slider_titles">
                            <input type="text" class="form-control" placeholder="{{translate('Title')}}" name="home_slider_titles[]">
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                            <input type="hidden" name="types[]" value="home_slider_contents">
                            <input type="text" class="form-control" placeholder="{{translate('Add Content')}}" name="home_slider_contents[]">
                            </div>
                            </div>
